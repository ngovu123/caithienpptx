...
def set_up_chat_ui():
    ...
    with st.expander('Usage Instructions'):
        ...
        st.markdown(
            'SparkHub AI is powered by'  # noqa: E501
    ...
    if prompt := st.chat_input(
        ...
        progress_bar = st.progress(0, 'Hệ thống đang chuẩn bị sử dụng mô hình AI.....')
        response = ''
        ...
        for chunk in _get_llm().stream(formatted_template):
            ...
            progress_bar.progress(
                progress_percentage,
                text='Đang chạy nội dung... điều này có thể mất một chút thời gian...'
            )
